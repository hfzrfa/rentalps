...
<div>
    ...
    <form method="POST" action="{{ route('bookings.store') }}" class="mt-6 space-y-4">
        ...
        <button type="submit" class="inline-flex items-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700">Booking</button>
    </form>
</div>
