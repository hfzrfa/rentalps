...
<div class="space-y-6">
    <div>
        <p class="text-sm text-gray-600">Login sebagai <span class="font-medium text-gray-900">{{ auth()->user()->name }}</span> (role: <span class="font-medium text-gray-900">{{ auth()->user()->role }}</span>)</p>
    </div>
