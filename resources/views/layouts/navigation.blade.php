            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center gap-2">
                        ...
                        <span class="font-semibold text-gray-800">Rental PS</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.playstations.index')" :active="request()->routeIs('admin.playstations.*')">
                            PlayStation
                        </x-nav-link>
                        <x-nav-link :href="route('admin.reports.bookings')" :active="request()->routeIs('admin.reports*')">
                            Laporan
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.playstations.index')" :active="request()->routeIs('admin.playstations.*')">
                    PlayStation
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('admin.reports.bookings')" :active="request()->routeIs('admin.reports*')">
                    Laporan
                </x-responsive-nav-link>
            @endif
        </div>
